...
@section('content_header')
    ...
    <h1 class="text-center text-dark font-weight-bold">{{ __('TIPO DE MATERIAL') }} <i class="fab fa-bitcoin"></i> </h1></a>
...
<a class="btn btn-dark" title="Crear Tipo de Moneda" href={{ route('type_materials.create') }}>
    <i class="fas fa-plus-circle"></i>
    <span class="d-none d-lg-inline-block text-uppercase font-weight-bold">{{ __('Crear') }}</span>
    <span class="d-none d-md-inline-block text-uppercase font-weight-bold">{{ __('Tipo de Material') }}</span>
</a>
<br><br>
    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header">
                <h3 class="card-title font-weight-bold">{{ __('TIPO DE MATERIALS') }} <i class="fab fa-bitcoin"></i></h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
