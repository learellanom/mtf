...
@switch($locale)
@case('es')
  <h6><li class="nav-item badge badge-light mt-2">Venezuela</li></h6>
@break

@case('en')
  <h6><li class="nav-item badge badge-light mt-2">Ingles</li></h6>
@break

@case('ar')
  <h6><li class="nav-item badge badge-light mt-2">Libano</li></h6>
@break
