...
<div class="container justify-content-center" style="display: contents;">
    ...
    <div class="row col-12 col-md-12 justify-content-center text-center align-items-center" style="min-height: 5rem !important">
        <h4>Resumen de comisiones Grupo USDT</h4>
    </div>
...
<script>
    ...
    $(() => {
        console.log('llega myFechaDesde ->  {{ $myFechaDesde }}'); 
        console.log('llega myFechaHasta ->  {{ $myFechaHasta }}'); 

        const myFechaDesde = {!! substr($myFechaDesde,0,4) !!} + '-' + {!! substr($myFechaDesde,5,1) !!} + {!! substr($myFechaDesde,6,1) !!} + '-' + {!! substr($myFechaDesde,8,1) !!} + {!! substr($myFechaDesde,9,1) !!} ;
        ...
        $('#wallet2, #grupo, #drCustomRanges').on('change', function (){
            // alert('leam - cambia');
            ...
            // alert(' myFechaDesde->' + myFechaDesde + ' myFechaHasta ->' + myFechaHasta);
    ...
    */
        ...
        <div class ="row mb-4" style="background-color: white;" data-wallet="">
            <div class="col-12 col-md-12">
                <table class="table thead-light" style="background-color: white;">
                    <thead class="thead-dark">
                        <tr>
                            <th class="myWidth22"             >Wallet Id</th>
                            <th class="myWidth22"             >Wallet</th>
                            <th class="myWidth22"             >Transacción ID</th>
                            ...
                            <th class="myTdColor6 myWidth22"  >Comision Ganancia</th>                            
                    ...
                    @if(count($Transacciones)>0)
                        @foreach($Transacciones as $wallet2)
                            ...
                            <tr class="myTr"  onClick="theRoute2({{$wallet2->WalletId}}, {{$wallet2->GroupId}}, {{$myFechaDesde}}, {{$myFechaHasta}})">
                                @php
                        ...
                        <tr style="background-color: black; color:white;">
                            ...
                            <td class="myTdColor6"  >{{ number_format($totalComisionGanancia,2) }}</td>     
    ...
    function theRoute(wallet = '', grupo = '', fechaDesde = '', fechaHasta = ''){

        let myRoute = "";

        myRoute = "{{ route('dashboardComisionesGrupoRes', ['wallet' => 'wallet2' , 'grupo' => 'grupo2', 'fechaDesde' => 'fechaDesde2', 'fechaHasta' => 'fechaHasta2']) }}";
    ...
    function theRoute2(wallet = 0, grupo = 0, typeTransactions = 0, fechaDesde = 0, fechaHasta = 0){
