...
@section('content_header')
    ...
    <h1 class="text-center text-dark font-weight-bold">{{ __('NUEVA TRANSACCION v2') }} <i class="fas fa-exchange-alt"></i> </h1></a>
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::select('type_coin_id',$type_coin, null, ['class' => 'form-control', 'required' => true, 'id' => 'typecoin', 'readonly' => false]) !!}
                            </div>
                        </div>
