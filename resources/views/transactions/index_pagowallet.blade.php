    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header">
                <div class="row">
                    <h3 class="card-title text-uppercase font-weight-bold col-12 col-md-6">{{ __('Pagos del Proveedor') }}</h3>
                                ...
                                <tr>
                                    ...
                                    @can('transactions.update_status')
                                        <td class="text-center">
                                            {!! Form::model($transferencias->TransactionId, 
                                                    ['route' => ['transactions.updatestatus_pago', $transferencias->TransactionId], 'method' => 'put']) !!}
...
$(document).ready(function () {
    ...
    function theRoute(user = 0, fechaDesde = 0, fechaHasta = 0){
        ...
        myRoute = "";
        myRoute = "{{ route('transactions.index_pagowallet', ['user' => 'user2', 'fechaDesde' => 'fechaDesde2', 'fechaHasta' => 'fechaHasta2']) }}"; 
