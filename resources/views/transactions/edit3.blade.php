...
<h1 class="text-center text-dark font-weight-bold">MODIFICAR TASA|COMISIÓN 3<i class="fas fa-coins"></i> </h1></a>
...
<div class="d-flex justify-content-center">
    <div class="card col-md-10" style="min-height:500px; !important; max-height:100%; height:100%; widht:100%">
        <div class="card-body">
            ...
            {!! Form::model($transactions, ['route' => ['transactions.update3', $transactions],'method' => 'put', 'autocomplete' => 'off', 'files' => true, 'enctype' =>'multipart/form-data', 'id' => 'myForm']) !!}
            <div class="row">
                <div class="col-md-4">
