            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            {!! Form::Label('mymonto_dolares', "Monto en dolares:") !!}
                            <div class="input-group-text">
                                <i class="fa-fw fas fas fa-funnel-dollar mr-2"></i>
                              {{--   {!! Form::text('amount', null, ['class' => 'form-control dolar general', 'required' => true, 'id' => 'mymonto_dolares', 'readonly' => true, 'data-mask-clearifnotmatch' => true]) !!} --}}
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group-text">
                                <i class="fa-fw fas fas fa-funnel-dollar mr-2"></i>
                                <input class="form-control dolar general" type="text" id="mymonto_dorales" name="amount" required readonly/>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        */
        ...
        $('#typecoin').on('change', function() {
            ...
            alert('cambia tpecoin -> ' + $('#typecoin').val());
            ...
            } else if ($('#typecoin').val() == null)
            {
                ...
                $('#mymonto_dolares').prop('readonly', 'readonly');
        ...
        $('.typecoin').on('change', function() {
            ...
            $('#mymonto_dolares').val("");    // LIMPIAR MONTO EN DOLARES
            ...
            if ($(this).val() == 1) {
                ...
                monto_dolares   = document.getElementById("mymonto_dolares");
                //const log = document.getElementById("montototal");

                $('#mymonto_dolares, #percentage').on('input', function() {
                ...
                $('#mymonto_dolares, #percentage_base').on('input', function() {
                    if(tasa.value == null && monto.value == null){
                        monto_total = monto_dolares;
                        monto_dolares.value =  monto_total.toFixed(2);
                    }
            ...
            else if ($(this).val() == null)
            {
                ...
                $('#tasa, #monto, #percentage').on('input', function() {
                    ...
                    if(tasa > 0 && monto > 0) {
                        ...
                        $('#mymonto_dolares').val(monto_total);
                    }
                ...
                $('#tasa, #monto, #tasa_base').on('input', function() {
                    ...
                    $('#montototal').val($('#mymonto_dolares').val());
    ...
    */
    function updateMontoreal(exonerar, descontar, incluir, comision, porcentage, montoreal) {
        ...
        let monto_dolares           = parseFloat($('#mymonto_dolares').val());
    ...
    */
    function updateTasaBase(comision_base, tasa_base, montoreal_base) {
        ...
        if(tasa_base > 0){
            //   $('#comision_base').val(parseFloat($('#mymonto_dolares').val()) - parseFloat($('#monto_extranjera_base').val()));
            // no debe grabar la comision en el campo

        }
        // aqui graba la ganancia comision
        $('#amount_commission_profit').val(parseFloat($('#mymonto_dolares').val()) - parseFloat($('#monto_extranjera_base').val()));
    }
    ...
    function calcula(){
        ...
        console.log('llega con ->' + amount_commission);
