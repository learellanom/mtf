...
@section('content_header')
    ...
    <h1 class="text-center text-dark font-weight-bold">{{ __('LISTA DE TRANSACCIONES v2') }} <i class="fas fa-people-arrows"></i> </h1></a>
                            ...
                            <thead>
                                ...
                                @foreach($transferencia as $transferencias)
                                    ...
                                    <tr style="height: 100px;">
                                        ...
                                        <td class="font-weight-bold" style="width: 90px; min-width: 90px;">
                                            {!! substr($transferencias->transaction_date,0,10) !!}
                                            <br>
                                            {!! substr($transferencias->transaction_date,11,8) !!}
                                        </td>
