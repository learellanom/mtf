...
@section('content_header')
    ...
    <h1 class="text-center text-dark font-weight-bold">{{ __('Adquisicion de Material Consolidado') }} <i class="fas fa-people-arrows"></i> </h1></a>
                        ...
                        <table class="table table-bordered table-responsive" id="table" style="width:100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:1%;"   >Cantidad</th>
                                    <th style="width:10%;"  >Monto</th>
                                    <th style="width:10%;"  >Saldo Monto</th>
                                    <th style="width:1%;"   >Saldo Cantidad</th>

                                    <th style="width:1%;"   >Nro Recepcion</th>
                                    <th style="width:1%;"   >Recepcion Fecha</th>
                                    <th style="width:10%;"  >Recepcion Cantidad</th>
                                    <th style="width:10%;"  >Recepcion Cantidad Asignado</th>
                                    <th style="width:10%;"  >Recepcion Monto Asignado</th>
