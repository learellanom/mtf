...
@section('content_header')
    ...
    <h1 class="text-center text-dark font-weight-bold">{{ __('ADQUISICION DE MATERIAL') }} <i class="fas fa-people-arrows"></i> </h1></a>
...
{{-- Compressed with style options / fill data using the plugin config --}}
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="row">
                    <h3 class="card-title text-uppercase font-weight-bold col-12 col-lg-6">{{ __('Adquisiciones') }} del {{ $fechaDesde}} al {{ $fechaHasta}}
                    </h3>
                        ...
                        <table class="table table-bordered table-responsive" id="table" style="width:100%;">
                            <thead>
                                <tr>
                                    ...
                                    @can('materials.adquisicion_edit')
                                ...
                                @foreach($movimientos as $movimiento)
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: none;">{!! $movimiento->type_material->name ?? '' !!}</td>
                                        @can('materials.adquisicion_update')
...
<script>
    ...
    function theRoute(user = 0, fechaDesde = 0, fechaHasta = 0, coin = 0){
        ...
        myRoute = "";
        myRoute = "{{ route('materials.adquisicion_index', ['user' => 'user2', 'fechaDesde' => 'fechaDesde2', 'fechaHasta' => 'fechaHasta2', 'coin' => 'coin2']) }}"; 
