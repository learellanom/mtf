...
@section('content_header')
    ...
    <h1 class="text-center text-dark font-weight-bold">NUEVA TRANSACCIÓN PROVEEDOR  <i class="fas fa-share"></i> </h1></a>
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::select('supplier_id',$proveedor, null,['class' => 'form-control clientes', 'required' => true, 'id' => 'clientes', 'readonly' => false]) !!}
                            </div>
                        </div>
