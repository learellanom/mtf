...
@section('title', 'Transacciones Proveedores')
@section('content_header')

    <h1 class="text-center text-dark font-weight-bold">VER MAS DE TRANSACCIÓN A PROVEEDORES <i class="fas fa-exchange-alt"></i> </h1></a>
<hr>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title text-uppercase font-weight-bold">Transacción a proveedores numero #{{ $transactions->id }}
          ...
          <p class="card-title text-uppercase font-weight-bold" style="margin-left: 500px;">Proveedor: {{ $transactions->supplier->name ?? 'SIN CAJA' }}</p>
                  ...
                  <h4 class="text-uppercase font-weight-bold text-center">Actividad reciente de {{ $transactions->supplier->name ?? 'Sin cliente' }}</h4>
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <span class="username">
                          <a href="#">{{ $transactione->supplier->name ?? 'Sin cliente' }}</a>
                        </span>
                    ...
                    @endforeach
                    @else
                        <p class="font-weight-bold text-center h5">ESTA TRANSACCIÓN NO TIENE ACTIVIDAD RECIENTE</p>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="text-muted">
                <p class="text-sm">Cliente
                  <b class="d-block">{{ $transactions->supplier->name ?? 'Sin cliente' }}</b>
                </p>
                <p class="text-sm">Numero de telefono
                  <b class="d-block">{{ $transactions->supplier->phone ?? 'Sin cliente' }}</b>
                </p>
              </div>
              <hr>
