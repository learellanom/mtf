...
<div class="container">
    ...
    <div>
            ...
            <input type="hidden" id="theFechaDesde" name="theFechaDesde" value="">
            <input type="hidden" id="theFechaHasta" name="theFechaHasta" value="">
            <input type="hidden" id="theCoin"       name="theCoin"       value="">
    </div>
    <nav >
...
<script>
    ...
    $(() => {
        ...
        $('#drCustomRanges').on('change', function () {
            ...
            theRoute(undefined, myFechaDesde,myFechaHasta);
		...
		$('#wallet').on('change', function (){
            ...
            theRoute(wallet, undefined, undefined);
    ...
    */
    ...
    function theRoute(wallet = null, fechaDesde = null, fechaHasta = null, coin = null){
