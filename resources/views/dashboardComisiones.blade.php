                    ...
                    <table class="table thead-light" style="background-color: white;">
                        <thead class="thead-dark">
                            ...
                            <tr>
                                ...
                                <th style="width:1%;">Entradas base</th>
                                <th style="width:1%;">Salidas base</th>
                                <th style="width:1%;">Comision base</th>
                                <th style="width:1%;">Saldo base</th>
                                <th style="width:1%;">Ganancia Comision</th>                                
                            </tr>
                        </thead>
                        @php
                            $cantCreditos  = 0;
        ...
        myElement = `
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center text-uppercase font-weight-bold">Consolidado de Comisiones</h3>
                            <canvas id="myChartDoughnut"></canvas>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table thead-light" style="background-color: white;">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th class="myTdColor2"      >Entradas</th>
                                <th class="myTdColor2"      >Salidas</th>
                                <th class="myTdColor2"      >Comision</th>
                                <th class="myTdColor2"      >Total</th>
                                <th class="myTdColor3"      >Entradas Base</th>
                                <th class="myTdColor3"      >Salidas Base</th>
                                <th class="myTdColor3"      >Comision Base</th>
                                <th class="myTdColor3"      >Total Base</th>
                                <th class="myTdColorBlack"  >Comision Ganancia</th>
                        ...
                        @foreach($transaction_summary as $wallet2)
                            ...
                            <tr class="myTr" onClick="theRoute2({{0}}, {{0}}, {{0}}, {{$wallet2->TypeTransactionId}})">
                                ...
                                <td class="{{$myStyle}}" >{{ number_format($total_amount_credit,2) == 0 ? "" : number_format($total_amount_credit,2) }}</td>
                                <td class="{{$myStyle}}" >{{ number_format($total_amount_debit,2)  == 0 ? "" : number_format($total_amount_debit,2) }}</td>
                                <td class="{{$myStyle}}" >{{ number_format($wallet2->total_commission ,2) == 0 ? "" : number_format($wallet2->total_commission ,2)}}</td>
                                <td class="{{$myStyle}}" >{{ number_format($wallet2->total ,2) == 0 ? "" :  number_format($wallet2->total ,2)}}</td>
                                <td class="{{$myStyle}}" >{{ number_format($total_amount_base_credit,2) == 0 ? "" : number_format($total_amount_base_credit,2)}}</td>
                                <td class="{{$myStyle}}" >{{ number_format($total_amount_base_debit,2)  == 0 ? "" : number_format($total_amount_base_debit,2)}}</td>
                                <td class="{{$myStyle}}" >{{ number_format($wallet2->total_Base,2)  == 0 ? "" : number_format($wallet2->total_Base,2)}}</td>
