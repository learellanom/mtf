...
<br>
<br>
<h1 class="text-center text-dark font-weight-bold">Resumen de Movimiento por Cliente</h1>
<br>
<br>
{{-- Disabled --}}
    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header">
                <h3 class="card-title">Estadisticas| Resumen por Cliente</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
...
<script>
    ...
    const miUsuario = {!! $myCliente !!};

    BuscaCliente(miUsuario);
    ...
    function theRoute(usuario = 0, cliente = 0, wallet = 0, fechaDesde = 0, fechaHasta = 0){
        ...
        let myRoute = "";
            myRoute = "{{ route('estadisticasResumenCliente', ['cliente' => 'cliente2', 'fechaDesde' => 'fechaDesde2', 'fechaHasta' => 'fechaHasta2']) }}";
