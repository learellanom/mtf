...
@section('title', 'Materiales liquidacion de cuentas')
@section('content')
...
<br>
<br>
<h1 class="text-center text-dark font-weight-bold text-uppercase">{{ __('Materiales liquidacion de cuentas') }} <i class="fas fa-w fa-box"></i></h1>
<br>
<br>
{{-- Disabled --}}
