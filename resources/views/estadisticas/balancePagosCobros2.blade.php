...
@section('content_header')
    ...
    <h1 class="text-center text-dark font-weight-bold">{{ __('Balance de Pagos y Cobros por Grupo / Fecha') }} <i class="fab fa-bitcoin"></i> </h1></a>
    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header">
                {{-- <h3 class="card-title font-weight-bold">{{ __('Balance de Pagos y Cobros por Grupo / Fecha') }} <i class="fab fa-bitcoin"></i></h3> --}}
...
let myRoute = "";
myRoute = "{{ route('balancePagosCobrosGrupoFecha', ['group' => 'group2','fechaDesde' => 'fechaDesde2', 'fechaHasta' => 'fechaHasta2', 'typeCoin' => 'typeCoin2']) }}";
