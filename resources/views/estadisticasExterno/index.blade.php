...
<div class="container-left">
    <div class="row col-12">
        ...
        {{-- dd($wallet) --}}
        <div class ="col-xl-2 col-sm-6 wallet">
        ...
        <div class ="col-xl-2 col-sm-6 group">
...
<script>
    ...
    //
    //
    //  Escode el wallet si no tiene asignado el usuario externo
    //  Escode el Grupo si no tiene asignado el usuario externo
    //     
    //
    if (miWallet == 0){
    ...
    function theRoute(usuario = 0, grupo = 0, wallet = 0, typeTransactions = 0, fechaDesde = 0, fechaHasta = 0, coin = 1){
        ...
        myRoute = "{{ route('estadisticasDetalleEU', ['usuario' => 'usuario2', 'grupo' => 'grupo2', 'wallet' => 'wallet2' , 'typeTransactions' => 'typeTransactions2', 'fechaDesde' => 'fechaDesde2', 'fechaHasta' => 'fechaHasta2', 'coin' => 'coin2']) }}";
