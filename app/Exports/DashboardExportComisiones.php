...
class DashboardExportComisiones implements FromView, WithColumnFormatting
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.excelComisiones', [
            'transaction_group_summary' => $this->transaction_group_summary,
            'transaction_summary'       => $this->transaction_summary,
            'wallet_summary'            => $this->wallet_summary,
            'wallet_groupsummary'       => $this->wallet_groupsummary,
