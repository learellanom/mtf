...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('transaction_requests',         Transaction_requestsController::class)->except('show')->middleware('can:transaction_requests.create')->names('transaction_requests');
